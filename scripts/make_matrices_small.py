...
# To combine the 11 output matrices use the combine_matrices.py script:
# $ python scripts/combine_matrices.py saved/fragments/matrix_SR0.010-0.100_D*.npz -o saved/matrix_SR0.010-0.100_D0.000-2.200.npz
