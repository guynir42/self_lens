...
def test_apparent_magnitudes(sim):
    ...
    # example 1: J0338
    sim.calculate(star_mass=0.23, star_temp=18100, orbital_period=1836.1 / 3600,
                  lens_mass=0.38, lens_temp=10000)
    ...
    # example 2: J0634
    sim.calculate(star_mass=0.452, star_temp=27300, orbital_period=1591.4 / 3600,
                  lens_mass=0.209, lens_temp=10500)
